...
public class ValueNode {
    ...
    private double outlierScore = 0;
    private double intraOD = -1;
    private double[] uncertainty;
    private double weight = 0;
    private double weightedDegree = 0;
    private String content = "";
    
    public ValueNode(int attrID, int valueID, Instances insts) {
        orgFeat = attrID;
        valueIndex = valueID;
    ...
    public ValueNode(Instances insts) {
        dim = insts.numAttributes()-1;
        size = insts.numInstances();
    ...
    public void generateGlobalCentroid(ValueNode localCentd) {
    ...
    public void setOutlierScore ( double od ) {
        outlierScore = od;
    }
    
    public void addOutlierScore ( double od ) {
        outlierScore += od;
    }
